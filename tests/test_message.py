...
class TestMessage(unittest.TestCase):
    ...
    def test_get_result(self):
        ...
        for action_dict in [{'action': 'delegate', 'version': 'v8', 'msg_index': 0}]:
            ...
            transaction_json = json.loads(Path(f'{os.path.dirname(__file__)}/data/{action}_{version}.json').read_text())
    ...
    def test_as_withdraw_delegator_reward(self):
        v8_delegate = json.loads(Path('%s/data/withdraw_delegator_reward_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_as_delegate(self):
        transaction = json.loads(Path('%s/data/delegate_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/begin_redelegate_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_begin_unbonding(self):
        v8_begin_unbonding = json.loads(Path('%s/data/begin_unbonding_v7.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_hard_deposit(self):
        v8_hard_deposit = json.loads(Path('%s/data/hard_deposit_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/harvest_deposit_v4.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_hard_withdraw(self):
        transaction = json.loads(Path('%s/data/hard_withdraw_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/harvest_withdraw_v4.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_hard_repay(self):
        v8_hard_repay = json.loads(Path('%s/data/hard_repay_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_hard_borrow(self):
        v8_hard_borrow = json.loads(Path('%s/data/hard_borrow_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_claim_hard_reward(self):
        transaction = json.loads(Path('%s/data/claim_hard_reward_v7.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/claim_harvest_reward_v4.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_create_cdp(self):
        v7_create_cdp = json.loads(Path('%s/data/create_cdp_v7.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_draw_cdp(self):
        v7_draw_cdp = json.loads(Path('%s/data/draw_cdp_v7.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_repay_cdp(self):
        v8_repay_cdp = json.loads(Path('%s/data/repay_cdp_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_deposit_cdp(self):
        v7_deposit_cdp = json.loads(Path('%s/data/deposit_cdp_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_withdraw_cdp(self):
        v8_withdraw_cdp = json.loads(Path('%s/data/withdraw_cdp_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_as_claim_usdx_minting_reward(self):
        transaction = json.loads(Path('%s/data/claim_usdx_minting_reward_v7.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/claim_reward_v6.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_createAtomicSwap(self):
        transaction = json.loads(Path('%s/data/createAtomicSwap_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/createAtomicSwap_v3.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_claimAtomicSwap(self):
        transaction = json.loads(Path('%s/data/claimAtomicSwap_v4.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/refundAtomicSwap_v6.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_swap_exact_for_tokens(self):
        transaction = json.loads(Path('%s/data/swap_exact_for_tokens_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/swap_for_exact_tokens_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_swap_deposit(self):
        transaction = json.loads(Path('%s/data/swap_deposit_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_swap_withdraw(self):
        transaction = json.loads(Path('%s/data/swap_withdraw_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_claim_swap_reward(self):
        transaction = json.loads(Path('%s/data/claim_swap_reward_v8.json' % os.path.dirname(__file__)).read_text())
    ...
    def test_send(self):
        transaction = json.loads(Path('%s/data/send_v8.json' % os.path.dirname(__file__)).read_text())
        ...
        transaction = json.loads(Path('%s/data/send_v2.json' % os.path.dirname(__file__)).read_text())
